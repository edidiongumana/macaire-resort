...
<!-- Mirrored from designarc.biz/demos/lakecious/booking.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Sep 2020 17:16:51 GMT -->
<head>
    <meta charset="UTF-8">
    <title>Macaire-Resort</title>
    <!-- reponsive meta-->
    ...
    <section class="top-bar dhomev">
      <div class="container">
        <div class="pull-left left-infos contact-infos">
          <ul class="list-inline">
            <li><a href="#"><i class="fa fa-phone"></i> +(234)08034672728</a></li>
            <!--comment for inline hack
            -->
            <li><a href="#"><i class="fa fa-map-marker"></i> 47A, Old Itu Road, Ikot Ekpene,
              Akwa Ibom State,</a></li>
            <!--comment for inline hack
            -->
            <li><a href="#"><i class="fa fa-envelope"></i>Macaire-Resort@email.com</a></li>
          </ul>
        </div>
    ...
    <nav id="main-navigation-wrapper" class="navbar navbar-default _fixed-header _light-header stricky">
      <div class="container">
        <div class="navbar-header">
          <button type="but;ton" data-toggle="collapse" data-target="#main-navigation" aria-expanded="false" class="navbar-toggle collapsed"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
          <a href="index.html" class="navbar-brand"><img alt="Awesome Image" src="images/header/mac logo.png"></a>
        </div>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 pull-left">
          <div class="book-left-content input_form">
            <form id="contactBooking" action="reserve.php" method="post">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                  <input id="name" type="text" name="phonenumber" placeholder="Phone(+234)" class="form-control" required>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                  <input placeholder="Arrival Date" name="arrivaldate" type="text" class="form-control datepicker-example8" required>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                  <input type="text" placeholder="Departure Date" name="departuredate" class="form-control datepicker-example8" required>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                  <div class="select-box">
                    <select name="chooseadults" class="select-menu" required>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 m0 col-xs-12">
                  <div class="select-box">
                    <select name="choosechildren" class="select-menu" required>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 m0 col-xs-12">
                  <div class="select-box">
                    <select name="chooseroom" class="select-menu" required>
                      <option value="default">Choose A Room</option>
                      <option value="Standard Room">Standard Room - ₦10,000/ weekend-₦5,000 </option>
                      <option value="Classic Room">Classic Room -₦13,000/ weekend-₦6,500 </option>
                      <option value="Macaire Double">Macaire Double - ₦15,000/ weekend-₦7,500</option>
                      <option value="Marcella Single">Marcella Single - ₦20,000/ weekend-₦10,000</option>
                      <option value="Marcella Double">Marcella Double - ₦25,000/ weekend-₦12,500</option>
                    </select>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-n12 col-md-12 col-sm-12 col-xs-12">
                  <textarea id="message" rows="6" name="comment" placeholder="Message" class="form-control"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 
                  <button type="submit" name="submit" value="Send" class="res-btn">Submit Now</button>
                </div>
              </div>
            </form>
        ...
        <div class="col-sm-4 pull-right">
          <div class="book-right"><span><img src="images/booking/1.jpg" alt=""></span>
            <h2>About Resort</h2>
            <p>Macaire Hotel and Resorts is a top hotel in IkotEkpene and is a regular choice for 
              guests in AkwaIbom. Located at 47A, Old Itu Road, IkotEkpene, AkwaIbom State, it is simple but classic hotel .
               In this hotel, you can be sure to have helpful staff, neat and clean surroundings - which generally accentuates the IkotEkpene culture,
                a hotel taxi to move around, and most importantly, a comfortable bed and good food. Come over and see for yourself.
              </p>
          </div>
        </div>
      </div>
    ...
    <footer>
      <section class="clearfix footer-wrapper">
        <section class="container clearfix footer-pad">
          <div class="widget about-us-widget col-md-4 col-sm-6"><a href="index-2.html"><img src="images/footer/mac logo.png" alt="" class="img-responsive"></a>
            <p> Macaire Resorts is a top hotel in Ikot Ekpene and is a regular
              choice for guests in Akwa Ibom..</p><a href="aboutus.html">Read More <i class="fa fa-angle-double-right"></i></a>
            <ul class="nav">
              <li><a href="#"><i class="fa fa-twitter"></i></a></li>
              <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
            ...
            <div class="widget-contact-list">
              <ul>
                <li><i class="fa fa-map-marker"></i>
                  <div class="fleft location_address"><b>Macaire-Resort</b><br>47A, Old Itu Road, Ikot Ekpene,
                    Akwa Ibom State,</div>
                </li>
                ...
                <li><i class="fa fa-envelope-o"></i>
                  <div class="fleft contact_mail"><a href="mailto:info@resorthotel.com">info@macaire-resort.com</a></div>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section class="container clearfix footer-b-pad">
        <div class="footer-copy">
          <div class="pull-left fo-txt">
            <p>Copyright © Macaire-Resort 2020. All rights reserved. </p>
          </div>
          <div class="pull-right fo-txt">
            <p>Created by: <a href="http://eddytech.ng">Eddytech I.C.T</a></p>
          </div>
        </div>
      </section>
    </footer>
...
<!-- Mirrored from designarc.biz/demos/lakecious/booking.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Sep 2020 17:16:52 GMT -->
</html>